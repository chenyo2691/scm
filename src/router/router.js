...
/**
 * meta title 用于显示window.document.title
 */
...
export const appRouter = [
    ...
    },
    {
        ...
        component: Main,
        children: [
            {path: 'test', title: '测试', name: 'test', icon: 'link', component: () => import('@/views/personal/Test.vue')},
            {path: 'test1', title: '测试1', name: 'test1', icon: 'link', component: () => import('@/views/personal/Test.vue')}
        ]
    },
    {
        path: '/rbac',
